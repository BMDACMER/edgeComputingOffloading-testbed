# DROP DATABASE edge_computing;
# DROP TABLE ec_task, ec_edge_node, ec_link;
...
(
    ...
    restart_time              double null,
    hop                       int null,
    final_execution_cluster_found int null,
    dynamic_redundancy_number int null
);
